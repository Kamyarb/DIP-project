...
img  = plt.imread('./Fig0457(a)(thumb_print).tif')
...
gaussianHPF= GaussHPF([img.shape[0], img.shape[1]] , sigma=10)
...
plt.subplot(122),plt.imshow((inverse_img).clip(0,255), cmap = 'gray')
# %%
